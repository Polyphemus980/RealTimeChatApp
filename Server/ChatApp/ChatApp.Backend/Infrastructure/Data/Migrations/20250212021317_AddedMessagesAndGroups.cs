...
{
    /// <inheritdoc />
    public partial class AddedMessagesAndGroups : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_MESSAGE_RECEIVER", "(ReceiverUserId IS NOT NULL AND ReceiverGroupId IS NULL) OR (ReceiverUserId IS NULL AND ReceiverGroupId IS NOT NULL)");
                    table.ForeignKey(
